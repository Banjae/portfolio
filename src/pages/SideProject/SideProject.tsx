        ...
        <div className={styles.sideProject}>
          <div className={styles.sideL}>
            ...
            <div className={styles.sideAbout}>
              ...
              <span className={styles.sideService}>
                '카카오맵 API' 와 'OpenWeatherMap API' 를 활용하여 <br /> 유저가
                설정한 지역의 날씨 데이터를 얻고, <br /> 그 날씨에 따라 신을
                신발을 추천해주는 서비스입니다.
              </span>
          ...
          <div className={styles.sideC}>
            <div className={styles.sideCT}>
              ...
              <div className={styles.sideAbout}>
                <span className={styles.sideTitle}>포트폴리오</span>
                <span className={styles.sideService}>
                  포트폴리오 웹사이트입니다.
                </span>
                <span className={styles.sideStack}>
            ...
            <div className={styles.sideCB}>
              ...
              />
              <div className={styles.sideAbout}>
                <span className={styles.sideTitle}>Todo-list</span>
                <span className={styles.sideService}>todo 리스트 입니다.</span>
                <span className={styles.sideStack}>HTML | CSS</span>
                <div className={styles.sideLink}>
                  <a href="" target="_blank" rel="noopener noreferrer">
                    <img
                      src={`${process.env.PUBLIC_URL}/images/link.png`}
          ...
          <div className={styles.sideR}>
            <div className={styles.sideRT}>
              <img src={`${process.env.PUBLIC_URL}/images/han.png`} alt="img" />
              <div className={styles.sideAbout}>
                <span className={styles.sideTitle}>한살림 장보기</span>
                <span className={styles.sideService}>
            ...
            <div className={styles.sideRB}>
              <img src={`${process.env.PUBLIC_URL}/images/stx.png`} alt="img" />
              <div className={styles.sideAbout}>
                <span className={styles.sideTitle}>STX건설</span>
                <span className={styles.sideService}>
                  "STX건설" 클론 코딩 웹사이트입니다.
                </span>
                <span className={styles.sideStack}>HTML | CSS</span>
